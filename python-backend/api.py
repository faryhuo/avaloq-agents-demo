...
def _get_agent_by_name(name: str):
    ...
    agents = {
        avaloq_triage_agent.name: avaloq_triage_agent,
        avaloq_faq_agent.name: avaloq_faq_agent,
        ba_agent.name: ba_agent,
        dev_agent.name: dev_agent,
        upgrade_agent.name: upgrade_agent,
    }
    return agents.get(name, avaloq_triage_agent)
...
def _build_agents_list() -> List[Dict[str, Any]]:
    ...
    return [
        make_agent_dict(avaloq_triage_agent),
        make_agent_dict(avaloq_faq_agent),
        make_agent_dict(ba_agent),
        make_agent_dict(dev_agent),
        make_agent_dict(upgrade_agent),
    ]
...
async def chat_endpoint(req: ChatRequest):
    ...
    if is_new:
        ...
        current_agent_name = avaloq_triage_agent.name
        state: Dict[str, Any] = {
            "input_items": [],
            "context": ctx,
